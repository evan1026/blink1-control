...
class Blink1Device_Good_test : public ::testing::Test {
    protected:
        void SetUp() override {
            fake_blink1_lib::SET_BLINK1_SUCCESSFUL_OPERATION(true);
            fake_blink1_lib::SET_BLINK1_VERSION(blink1Version);
        }
        ...
        int blink1Version = 1337;
};

TEST_F(Blink1Device_Good_test, TestGood) {
    {
        Blink1Device device;
...
TEST_F(Blink1Device_Good_test, TestOperatorBool) {
    {
        Blink1Device device;
...
TEST_F(Blink1Device_Good_test, TestGetVersion) {
    {
        Blink1Device device;
        ...
        if (deviceVersion) { // Avoid throwing exception if it's not present
            EXPECT_EQ(blink1Version, deviceVersion());
        }
    }
    checkDevicesFreed();
}

TEST_F(Blink1Device_Good_test, TestFadeToRGB) {
    {
        Blink1Device device;
        RGB rgb(10, 11, 12);
...
TEST_F(Blink1Device_Good_test, TestFadeToRGBN) {
    {
        Blink1Device device;
...
TEST_F(Blink1Device_Good_test, TestSetRGB) {
    {
        Blink1Device device;
        RGB rgb(10, 11, 12);
...
TEST_F(Blink1Device_Good_test, TestSetRGBN) {
    {
        Blink1Device device;
        RGBN rgb(10, 11, 12, 20);
...
TEST_F(Blink1Device_Good_test, TestReadRGBWithFade) {
    {
        Blink1Device device;
        RGB rgb(10, 11, 12);
...
TEST_F(Blink1Device_Good_test, TestReadRGB) {
    {
        Blink1Device device;
        RGB rgb(10, 11, 12);
        std::uint16_t fadeMillis = 97;
...
TEST_F(Blink1Device_Good_test, TestPlay) {
    {
        Blink1Device device;
...
TEST_F(Blink1Device_Good_test, TestPlayLoop) {
    {
        Blink1Device device;
...
TEST_F(Blink1Device_Good_test, TestStop) {
    {
        Blink1Device device;
...
TEST_F(Blink1Device_Good_test, TestReadPlayState) {
    {
        Blink1Device device;
...
TEST_F(Blink1Device_Good_test, TestWritePatternLine) {
    {
        Blink1Device device;
...
TEST_F(Blink1Device_Good_test, TestWritePatternLineN) {
    {
        Blink1Device device;
...
TEST_F(Blink1Device_Good_test, TestReadPatternLine) {
    {
        Blink1Device device;
...
TEST_F(Blink1Device_Good_test, TestReadPatternLineN) {
    {
        Blink1Device device;
...
TEST_F(Blink1Device_Good_test, TestSavePattern) {
    {
        Blink1Device device;
...
TEST_F(Blink1Device_Good_test, TestDegamma) {
    {
...
TEST_F(Blink1Device_Good_test, TestVid) {
    {
...
TEST_F(Blink1Device_Good_test, TestPid) {
    {
...
TEST_F(Blink1Device_Good_test, TestGetCacheIndex) {
    {
        Blink1Device device;
...
TEST_F(Blink1Device_Good_test, TestClearCache) {
    {
        Blink1Device device;
...
TEST_F(Blink1Device_Good_test, TestGetSerial) {
    {
        Blink1Device device;
...
TEST_F(Blink1Device_Good_test, TestIsMk2) {
    {
        Blink1Device device;
